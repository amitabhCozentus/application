...
describe('RoleControlComponent', () => {
    ...
    beforeEach(() => {
        // Create a writable signal for layout config
        ...
        }).overrideComponent(RoleControlComponent, {
            set: {
                imports: [] // Override imports to prevent dependency issues
            }
        });
    ...
    describe('ngOnInit', () => {
        it('should call loadRoles with default parameters', () => {
            spyOn(component, 'loadRoles');
            component.ngOnInit();
            expect(component.loadRoles).toHaveBeenCalledWith(0, 10);
        });

        it('should log primary colors on initialization', () => {
            spyOn(console, 'log');
            component.ngOnInit();
            expect(console.log).toHaveBeenCalledWith('Primary Colors:', jasmine.any(Array));
        });
    });
    ...
    describe('loadRoles', () => {
        ...
        it('should log roles data on successful load', (done) => {
            spyOn(console, 'log');
            component.loadRoles(0, 10);

            setTimeout(() => {
                expect(console.log).toHaveBeenCalledWith('Roles loaded:', jasmine.any(Array));
                done();
            });
        });
    ...
    describe('Refresh Functionality', () => {
        it('should reload roles with current page and size parameters', () => {
            ...
            expect(component.loadRoles).toHaveBeenCalledWith(3, 15);
        });
    ...
    describe('Dialog Operations', () => {
        ...
        it('should handle null role data in editRole', () => {
            ...
            expect(component.roleConfig.open).toHaveBeenCalledWith(null);
        });
    });
    ...
    describe('Error Handling', () => {
        ...
        it('should handle service response with missing total property', (done) => {
            ...
            setTimeout(() => {
                expect(component.loading).toBe(false);
                expect(component.roles.length).toBe(1);
                expect(component.totalRecords).toBe(0); // Should default to 0
                done();
            });
        });
    ...
    describe('ViewChild and Template Integration', () => {
        it('should have roleConfig ViewChild properly mocked', () => {
            ...
            expect(component.roleConfig.open).toBeDefined();
            expect(typeof component.roleConfig.open).toBe('function');
        });
        ...
        it('should handle roleConfig ViewChild method calls', () => {
            ...
            expect(component.roleConfig.open).toHaveBeenCalledTimes(2);
        });
    });
    ...
    describe('Console Logging', () => {
        it('should log primary colors on ngOnInit', () => {
            spyOn(console, 'log');
            component.ngOnInit();
            expect(console.log).toHaveBeenCalledWith('Primary Colors:', jasmine.any(Array));
        });

        it('should log roles data after successful load', (done) => {
            spyOn(console, 'log');
            component.loadRoles(0, 10);
    ...
    describe('Component Lifecycle and Memory Management', () => {
        it('should handle component reinitialization', () => {
            ...
            expect(mockRoleService.getActiveRoles).toHaveBeenCalledTimes(2);
        });
    ...
    describe('Dialog Integration Advanced Cases', () => {
        it('should handle editRole with complex role data', () => {
            ...
            expect(component.roleConfig.open).toHaveBeenCalledWith(complexRole);
        });
        ...
        it('should handle multiple rapid dialog operations', () => {
            ...
            expect(component.roleConfig.open).toHaveBeenCalledTimes(4);
            expect(component.roleConfig.open).toHaveBeenCalledWith(role1);
            expect(component.roleConfig.open).toHaveBeenCalledWith(role2);
            expect(component.roleConfig.open).toHaveBeenCalledWith(); // Called twice for add dialog
        });
    });
});
