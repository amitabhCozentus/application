...
import { CUSTOM_LANDING, ROLE_TABLE_HEADERS, RoleConfigData, TableHeaders } from "../../../../shared/lib/constants";
...
export class RoleControlComponent implements OnInit {
    ...
    loadRoles(
        ...
        pageSize: number,
        searchTerm: string,
        columnFilters: ColumnFilterDescriptor[] = this.lastColumnFilters
    ) {
        this.loading = true;
