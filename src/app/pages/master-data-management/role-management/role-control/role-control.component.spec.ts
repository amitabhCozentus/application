  ...
  describe('Component Initialization', () => {
    ...
    describe('loadRoles', () => {
        it('should set loading to true initially', () => {
            ...
            spyOn(component, 'loadRoles').and.callFake(function (
      this: RoleControlComponent,
      pageIndex: number,
      pageSize: number,
      searchTerm: string,
      columnFilters?: ColumnFilterDescriptor[]
    ) {
      // Immediately set loading and test
      this.loading = true;
      expect(this.loading).toBeTrue();

      // Call the real method with all args
      return originalLoadRoles.call(this, pageIndex, pageSize, searchTerm, columnFilters);
    });

    // Call with all required args
